	...
	public DS() {
		...
		btndeleteData.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String trainer_id  = nameCB.getItemAt(nameCB.getSelectedIndex());

				if (trainer_id  == null || trainer_id .trim().length() == 0) {
					JOptionPane.showMessageDialog(null,
							"Please Select the Field");
					System.out.println("Text:" +trainer_id );
				} else {
					query.append("delete from trainer where trainer_id =('")
		...
		JLabel studentDBManagement = new JLabel("DELETE TRAINER DETAILS ",
				JLabel.CENTER);
