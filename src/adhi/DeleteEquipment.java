...
public class DeleteEquipment extends JFrame {
	...
	public DeleteEquipment() {
		...
		btndeleteData.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (CUST_ID  == null || CUST_ID .trim().length() == 0) {
					...
					query.append("delete from equipment where CUST_ID =('")
		...
		JLabel studentDBManagement = new JLabel("DELETE EQUIPMENT DETAILS",
				JLabel.CENTER);
