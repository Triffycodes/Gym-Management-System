...
public class deleteMembership extends JFrame {
	static deleteMembership frame;
	...
	public deleteMembership() {
		...
		btndeleteData.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (CUST_ID  == null || CUST_ID .trim().length() == 0) {
					...
					query.append("delete from membership where CUST_ID =('")
		...
		JLabel studentDBManagement = new JLabel("DELETE MEMBERSHIP DETAILS",
				JLabel.CENTER);
